		...
		<div id="box_wrapper">
			...
			<section class="intro_section page_mainslider ds color">
				<div class="flexslider" data-dots="true" data-nav="false">
					<ul class="slides">
						<li> <img src="./images/images/0052.jpg" alt="">
							<div class="container">
								<div class="row">
			...
			<section id="about" class="ls section_padding_top_150 section_padding_bottom_150">
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							<h2 class="section_header"> Welcome to Drug House! </h2>
					...
					<div class="row columns_margin_bottom_20">
						<div class="col-md-4 col-sm-6">
							<div class="teaser hover_icon with_padding big-padding with_border rounded text-center">
								...
								<h4 class="topmargin_20 hover-color2"><a href="team.html">Drug House Team</a></h4>
						...
						<div class="col-md-4 col-sm-6">
							<div class="teaser hover_icon with_padding big-padding with_border rounded text-center with_corner_border">
								...
								<h4 class="topmargin_20 hover-color2"><a href="departments.html">Drug House Focus</a></h4>
						...
						<div class="col-md-4 col-sm-6 col-sm-offset-3 col-md-offset-0">
							<div class="teaser hover_icon with_padding big-padding with_border rounded text-center">
								...
								<h4 class="topmargin_20 hover-color2"><a href="pipeline.html">Drug House Pipeline</a></h4>
			...
			<section id="products" class="ds color parallax page_gallery section_padding_top_100 section_padding_bottom_150 columns_padding_25">
				<div class="container">
					<div class="row display_table_md">
						<div class="col-md-6 col-md-push-6 display_table_cell_md"> <img src="images/images/gallery/010.jpg" alt="" class="rounded"> </div>
						<div class="col-md-6 col-md-pull-6 display_table_cell_md">
							...
							<p class="topmargin_30"> <a href="testshop-product.php" class="theme_button color2 inverse">See All Products</a> </p>
						</div>
					</div>
						...
						<div class="col-sm-12">
							<div class="owl-carousel gallery-carousel" data-responsive-lg="5" data-responsive-md="4" data-responsive-sm="3" data-responsive-xs="1" data-nav="true">
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/002.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/002.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/004.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/03.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/005.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/04.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/006.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/05.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/007.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/06.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/008.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/07.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
								<div class="gallery-item rounded">
									<div class="item-media rounded overflow_hidden"> <img src="images/images/gallery/009.jpg" alt="">
										<div class="media-links inverse"> <a href="images/images/gallery/08.jpg" class="abs-link prettyPhoto" title="" data-gal="prettyPhoto[gal]"></a> </div>
									</div>
								</div>
							</div>
						</div>
							...
							<div class="row topmargin_40 columns_margin_bottom_20">
								...
								<div class="col-sm-4 col-xs-6 col-xxs-12">
									<div class="vertical-item teaser clear-media hover_bg_teaser ls with_padding rounded with_shadow min_height_165">
										...
										<div class="media-links clear-media"> <a href="#" class="abs-link"></a> </div>
									</div>
								</div>
								<div class="col-sm-4 col-xs-6 col-xxs-12">
									<div class="vertical-item teaser clear-media hover_bg_teaser ls with_padding rounded with_shadow min_height_165">
								...
								<div class="row">
										...
										<div class="panel-group" id="posts-accordion1">
											<div class="panel panel-blog-post">
												<div class="panel-heading"> <a data-toggle="collapse" data-parent="#posts-accordion1" href="#blog-collapse1">
													...
													<h4 class="hover-color2"> <a href="blog-single-right.html">Pharma companies still facing GST rollout blues</a> </h4>
												...
												<div id="blog-collapse1" class="panel-collapse collapse in">
													<div class="panel-body"> With two days for implementation of the goods and services tax in India, the country’s pharmaceutical industry fears that availability of medicines! </div>
												</div>
											</div>
											<div class="panel panel-blog-post">
												<div class="panel-heading"> <a data-toggle="collapse" data-parent="#posts-accordion1" href="#blog-collapse2" class="collapsed">											
													...
													<h4 class="hover-color2"> <a href="blog-single-right.html">27 medicines sold by top firms ‘fail’ quality tests in seven states</a> </h4>
													<div class="content-justify greylinks fontsize_12"> <a href="#">
												...
												<div id="blog-collapse2" class="panel-collapse collapse">
													<div class="panel-body"> In a major crackdown since March this year, the drug regulators of seven states have alleged that 27 medicines — sold by 18 major drug companies ! </div>
												</div>
											</div>
											<div class="panel panel-blog-post">
												<div class="panel-heading"> <a data-toggle="collapse" data-parent="#posts-accordion1" href="#blog-collapse3" class="collapsed">											
													...
													<h4 class="hover-color2"> <a href="blog-single-right.html">Modi Govt's Generic Push will dent Rs 90,000-cr branded Pharma Market</a> </h4>
													<div class="content-justify greylinks fontsize_12"> <a href="#">
												...
												<div id="blog-collapse3" class="panel-collapse collapse">
													<div class="panel-body"> Pharma companies may soon start wooing chemists as the Narendra Modi government plans to make it mandatory for doctors to prescribe pure-generic drugs! </div>
												</div>
											</div>
										</div>
									</div>
									<div class="col-md-6">
										<div class="vertical-item content-absolute content-padding">
											<div class="item-media rounded overflow_hidden ds black"> <img src="images/images/blog_post1.jpg" alt="">
												<div class="date entry-meta-corner main_bg_color"> <span>04</span> <span>10/17</span> </div>
											</div>
											<div class="item-content ds">
												<h4 class="entry-title highlight hover-color2 bottommargin_0"> <a href="blog-single-right.html">Modi Govt's Generic Push will dent Rs 90,000-cr branded Pharma Market</a> </h4>
					...
					<div class="row">
						<div class="col-sm-12">
							...
							<div class="owl-carousel" data-responsive-lg="3" data-nav="false" data-dots="true">
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/faces/1.jpg" alt=""> Good customer service can sometimes be difficult to come across these days, but Evaluate has always been first rate from my experience.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Heidi J. Cobb</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="ls with_border with_padding text-center rounded"> <img src="images/faces/2.jpg" alt="">Pharma is by far the best database at my disposal...when one comes along like yours that is actually well engineered and does its job well, it’s worth making a note and thanking someone!
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Felicia L. Brooks</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/faces/3.jpg" alt="">I’ve quickly turned into a big fan of EvaluatePharma.  The information on the website is saving me a lot of time and effort and is really hitting the nail on the head.									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Frank C. McGee</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/faces/4.jpg" alt=""> The actual sales numbers provided are among the most reliable in the industry.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Heidi J. Cobb</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="ls with_border with_padding text-center rounded"> <img src="images/faces/5.jpg" alt=""> I really could not do my job without EvaluatePharma. You guys make me look good all the time.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Felicia L. Brooks</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/faces/6.jpg" alt=""> We don’t want a moment to elapse with not having the Evaluate product – it is a huge asset to our work.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Frank C. McGee</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/images/faces/7.jpg" alt=""> Consetetur sadipscing elitr, sed diam nonumy eirmod tempor invidunt utlabore et dolore magna aliquyam.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Heidi J. Cobb</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="ls with_border with_padding text-center rounded"> <img src="images/images/faces/8.jpg" alt="">As always, EP has done a great job of supporting what has become a great resource for my company.
									<div class="item-meta">
										<h5 class="highlight hover-dark-color"><a href="#">Felicia L. Brooks</a></h5>
										<p class="highlight2">Customer</p>
									</div>
								</blockquote>
								<blockquote class="with_border with_padding text-center rounded"> <img src="images/faces/9.jpg" alt=""> Someone’s actually thought about what’s happened, as opposed to just writing about it....
			...
			<section class="cs gradient section_padding_top_50 section_padding_bottom_50">
				<div class="container-fluid">
					<div class="row">
						...
						<img src="images/images/partners/01.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/02.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/03.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/04.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/05.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/06.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/07.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/08.png" alt="">
					</a> <a href="#">
						<img src="images/images/partners/09.png" alt="">
					</a> </div>
						</div>
					</div>
				</div>
