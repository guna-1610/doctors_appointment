<footer class="page_footer ds color section_padding_top_100 section_padding_bottom_65 table_section">
				<div class="container">
					<div class="row">
	                    ...
	                    <img src="images/logo.jpg" alt="" width="80%" float="left" style="margin-left: 0px">
	                </a>
				...
				<div class="container">
					<div class="row">
						<div class="col-sm-12 text-center">
							...
							<p class="fontsize_12">Developed By : <a href="https://projecttunnel.com" target="_blank"> projecttunnel</a> </p>
						</div>
					</div>
				</div>
			</section>
