  ...
  <section id="container" class="">
      ...
      <section id="main-content">
		  ...
		  <div class="row">
              ...
              <div class="row">
                  <div class="col-lg-12">
					...
					<a onclick="return confirm('Are you sure you want to delete this record');" href="model/admin_model_doctors_Delete.php?
		 ...
		 "  title="edit" class="btn btn-success">
          ...
          <td><a href="./model/addDoctor.php?cid=<?php echo $row['did'];?>">Add</a></td>
